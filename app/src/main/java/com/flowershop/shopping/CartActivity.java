...
import com.flowershop.shopping.Model.Cart;
import com.flowershop.shopping.Prevalent.CartViewHolder;
import com.flowershop.shopping.Prevalent.Prevalent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtTotalAmount.setText("Total Price = Peso."+String.valueOf(overTotalPrice));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                holder.txtProductPrice.setText("Price = "+model.getPrice()+" Peso");
